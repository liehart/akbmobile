...
class _SearchScreenState extends State<SearchScreen> {
        ...
        slivers: [
          SliverAppBar(
              ...
              child: Theme(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: _textEditingController.text.length > 0 ? GestureDetector(
                      onTap: () {
                        FocusScope.of(context).unfocus();
            ...
            bottom: PreferredSize(
              ...
              child: _isSearching ? LinearProgressIndicator(
                minHeight: 2,
          ...
          (_data.length > 0 && _query != "") ? SliverList(
          ...
          ) : (_query != "" && _query.length > 2) ? SliverFillRemaining(
            hasScrollBody: false,
            fillOverscroll: true,
            child: Container(
  ...
  _search(String text) async {
    ...
    setState(() {
      _data = List<Menu>.from(
          snapshot.hits.map((x) => Menu.fromJson(x.data))
      );
      _isSearching = false;
    });
  }
